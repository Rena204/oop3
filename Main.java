...
public class Main {
    ...
    private static void Over70 () {
        employee[] AllEmployee = new employee[5];
        AllEmployee[0] = new employee("Хакимуллин Тимур", "Тестировщик", "test@test.ru", "+7777777888", 30000,77);
        ...
        AllEmployee[3] = new employee("Попов Михаил", "Frontend", "test@test.ru", "+7777777888", 30000,80);
        AllEmployee[4] = new employee("Ахметшина Алина", "Тестировщик", "test@test.ru", "+7777777888", 30000,41);

        System.out.println("\nСотрудники старше 70 лет:");
        for (int i = 0; i < AllEmployee.length; i++) {
            if(AllEmployee[i].age > 70) {
